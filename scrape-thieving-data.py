...
def main():
    ...
    lines.append('//')
    lines.append('// This data is derived from the Old School RuneScape Wiki and is licensed')
    lines.append('// under CC BY-NC-SA 3.0 (https://creativecommons.org/licenses/by-nc-sa/3.0/),')
    lines.append('// NOT the repository\'s MIT code license. It uses material from the')
    lines.append('// pickpocket-target articles and {{Skilling success chart}} template on the')
    lines.append('// OSRS Wiki (https://oldschool.runescape.wiki). See LICENSE-DATA.md for details.')
